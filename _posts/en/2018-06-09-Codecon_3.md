...
Each implementation will rely on the `decode` function presented in [part 1]({{ prev_url }}#decoding) of the series. The full source code is also available on my [GitHub]({{ site.github.url }}/assets/src/codecon18/).
